...
#
# The order is not cosmetic: a wrong bin map (batch 1) makes batch 5's disagreement statistics
# meaningless, and a scrambled reference (batch 2) makes every malignancy number downstream
# meaningless. Advancing past a failure produces numbers that look fine and mean nothing, which is
